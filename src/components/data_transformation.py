...
from sklearn.impute import SimpleImputer # Imputer is used to fill the missing values
...
class DataTransformation:
    ...
    def get_data_transformer_object(self): # This function will be responsible for creating pickle files, which will be responsible for converting categorical features into numerical features, and standard scaling
        try:
    ...
    def initiate_data_transformation(self, train_path,test_path):
        try:
            ...
            logging.info('Applying the preprocessing object on the train data')
